			...
			if($ShowSocial){
				...
				$authorsocial .= '<ul class="author-social">';
					...
					if(!empty($author_email)){
						$authorsocial .= '<li><a href="mailto:'.esc_url($author_email).'" rel="'.esc_attr__("email","theplus").'"><i class="fas fa-envelope"></i></a></li>';
					}
					if(!empty($author_number)){
						$authorsocial .= '<li><a href="tel:'.esc_url($author_number).'" rel="'.esc_attr__("author_number","theplus").'"><i class="fas fa-phone-alt"></i></a></li>';
					}
