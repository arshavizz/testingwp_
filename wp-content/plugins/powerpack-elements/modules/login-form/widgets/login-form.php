...
\		 */
	...
	private function get_lost_password_form( $settings, $id ) {
		...
		<p><?php echo apply_filters( 'pp_login_form_lost_password_message', esc_html__( 'Lost your password? Please enter your username or email address. You will receive a link to create a new password via email.', 'powerpack' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
		<div class="pp-login-form-fields">
			<div class="elementor-field-group elementor-column elementor-col-100">
				<?php if ( $settings['show_labels'] ) { ?>
				<label for="user_login"><?php esc_html_e( 'Username or Email', 'powerpack' ); ?></label>
				<?php } ?>
			...
			<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'submit-group' ) ); ?>>
				<button <?php echo wp_kses_post( $this->get_render_attribute_string( 'lost_password_button' ) ); ?>>
					<span class="pp-login-form--button-text"><?php esc_html_e( 'Reset password', 'powerpack' ); ?></span>
				</button>
			</div>
		</div>
