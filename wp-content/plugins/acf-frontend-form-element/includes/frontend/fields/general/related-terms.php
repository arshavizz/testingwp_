...
class acf_field_related_terms extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		add_filter( 'acf/load_field/type=taxonomy',  [ $this, 'load_taxonomy_field'] );
		add_filter( 'acf/load_value/type=taxonomy',  [ $this, 'load_taxonomy_value'], 9, 3);
	...
	function load_taxonomy_value( $value, $post_id = false, $field = false ){
