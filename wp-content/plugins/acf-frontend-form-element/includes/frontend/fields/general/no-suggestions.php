...
if( ! class_exists('acf_field_no_suggestions') ) :

class acf_field_no_suggestions extends acf_field_text {
	...
	*/
	...
	function render_field( $field ) {
		...
		// Input.
		$input_attrs = array( 'type' => 'text', 'autocomplete' => 'no' );
...
// initialize
acf_register_field_type( 'acf_field_no_suggestions' );
