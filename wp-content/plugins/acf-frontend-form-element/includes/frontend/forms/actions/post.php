...
class ActionPost extends ActionBase {
	...
	public function action_controls( $widget, $step = false ){
		...
		$condition['main_action'] = ['edit_post', 'delete_post', 'duplicate_post'];
	...
	public function on_submit( $post_id, $form ){	
		...
		//$wg_id = isset( $_POST['_acf_field_id'] ) ? '_' . str_replace( 'field_', '', $_POST['_acf_field_id'] ) : $wg_id;
